...
window.onload = function () {
    ...
    var box = document.getElementsByClassName("fs-inner-middle");
    var lists = document.getElementById("fs-middle-imgList");
    var list = lists.getElementsByTagName("li");
    var buttons = document.getElementById("fs-middle-buttons").getElementsByTagName("span");
    var prev = document.getElementById("fs-middle-prev");
    var next = document.getElementById("fs-middle-next");
    var index = 1;
    var cur = 1;
    function assign() {
