addLoadEvent(function () {
    ...
    var list = document.getElementById("daily_box_inner");
    var buttons = document.getElementById("daily_buttons").getElementsByTagName("span");
    var prev = document.getElementById("daily_prev");
    var next = document.getElementById("daily_next");
    var index = 1;
    var timer;
    var timers;
    ...
    function show() {
        for (var i=0;i<buttons.length;i++){
            if(buttons[i].className == "daily_button daily_on"){
                buttons[i].classList.remove("daily_on");
            }
        }
        addClass(buttons[index-1],"daily_on");
    }
